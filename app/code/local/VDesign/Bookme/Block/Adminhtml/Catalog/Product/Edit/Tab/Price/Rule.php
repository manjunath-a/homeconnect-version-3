...
class VDesign_Bookme_Block_Adminhtml_Catalog_Product_Edit_Tab_Price_Rule
...
implements Varien_Data_Form_Element_Renderer_Interface
{
	...
	{
		$this->setTemplate('vdesign_bookme/edit/price/rule.phtml');
	}
	...
	protected function _prepareLayout()
	{
		...
		->setData(array(
				'label' => Mage::helper('bookme')->__('Add Rule'),
