...
class Megnor_Manufacturer_Adminhtml_ManufacturerController extends Mage_Adminhtml_Controller_action
{
	...
	public function indexAction() {
        ...
        $this->_initAction();
        $this->_addContent($this->getLayout()->createBlock('manufacturer/adminhtml_manufacturer'));
        $this->renderLayout();
	...
	public function saveAction() {
        ...
        $collection=Mage::getModel('manufacturer/manufacturer')->getCollection()->addFieldToFilter('manufacturer_name',$data['manufacturer_name']);
		...
		if ($data) {
			if(isset($_FILES['filename']['name']) && $_FILES['filename']['name'] != '') {
				...
				$data['filename'] = 'manufacturer/'.preg_replace("#\s+#","_", $_FILES['filename']['name']);
			}else{
