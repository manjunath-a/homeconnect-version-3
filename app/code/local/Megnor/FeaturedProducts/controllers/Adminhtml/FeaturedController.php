 ...
 */
class Megnor_FeaturedProducts_Adminhtml_FeaturedController extends Mage_Adminhtml_Controller_Action {
    ...
    public function saveAction() {
        ...
        try {
            ...
            foreach ($collection->getItems() as $product) {
                ...
                $product->setData('megnor_featured_product', $featured_products[$product->getEntityId()]);
