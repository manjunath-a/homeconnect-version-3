 ...
 */
class Megnor_FeaturedProducts_Block_Listing extends Mage_Catalog_Block_Product_Abstract {
    /*
    ...
    public function __construct() {
        ...
        $this->setTemplate('featured/featuredproducts/block_featured_products.phtml');
    ...
    protected function _beforeToHtml() {
        ...
        $collection->addAttributeToSelect($attributes)
                ...
                ->addFinalPrice()
                ->addTaxPercents()
                ->addAttributeToFilter('megnor_featured_product', 1, 'left')
                ->addStoreFilter()
