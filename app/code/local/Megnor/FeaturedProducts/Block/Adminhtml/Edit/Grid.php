 ...
 */
class Megnor_FeaturedProducts_Block_Adminhtml_Edit_Grid extends Mage_Adminhtml_Block_Widget_Grid {

    public function __construct() {
        parent::__construct();

        $this->setId('megnor_featured_products');
    ...
    protected function _prepareCollection() {
        ...
        if ($action_name == 'exportCsv' || $action_name == 'exportXml') {
            $collection->addAttributeToFilter('megnor_featured_product', array('eq' => true));
        }
    ...
    protected function _getSelectedProducts($json = false) {
        ...
        $_prod = Mage::getModel('catalog/product')->getCollection()
                ->joinAttribute('megnor_featured_product', 'catalog_product/megnor_featured_product', 'entity_id', null, 'left', $store->getId())
    ...
    document.observe("dom:loaded", function() {
        ...
        var everycheckbox = $$("#megnor_featured_products_table tbody input.checkbox");
...
EndHTML;
    ...
    private function _appendHtml() {
		...
		var checkbox_all = $$("#megnor_featured_products_table thead input.checkbox").first();
        	var everycheckbox = $$("#megnor_featured_products_table tbody input.checkbox");
